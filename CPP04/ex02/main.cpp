...
/*   Updated: 2024/07/23 13:10:48 by dboire           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	wrongcat_brain[1] = wrong_array[0]->get_brain();
	...
	std::cout << wrongcat_brain[1]->ideas[0] << std::endl;
	...
	delete wrong_array[0];
	delete wrong_array[1];
	delete array[0];
	delete array[1];
	delete array[2];
	delete array[3];
